...
const registrerUserController = {};

registrerUserController.registrer = async (req, res) => {
    try{
        const {
            name,
        email,
        ...
        const existUsers = await userModel.findOne({email})
...
registrerUserController.verifyCode = async (req, res) => {
    try{
...
export default registrerUserController
